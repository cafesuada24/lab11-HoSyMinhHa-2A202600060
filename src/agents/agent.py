...
def create_unsafe_agent() -> tuple[llm_agent.LlmAgent, runners.Runner]:
...
) -> tuple[llm_agent.LlmAgent, runners.Runner]:
...
async def test_agent(agent: llm_agent.LlmAgent, runner: runners.Runner) -> None:
